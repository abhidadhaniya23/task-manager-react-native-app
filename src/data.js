export const elementData = [
    ...
    },
    {
        ...
        spectral_img: "-",
        summary: 'Lithium (from Greek:????? lithos, "stone") is a chemical element with the symbol Li and atomic number 3. It is a soft, silver-white metal belonging to the alkali metal group of chemical elements. Under standard conditions it is the lightest metal and the least dense solid element.',
        symbol: "Li",
        xpos: 1,
        ypos: 2,
        shells: [2, 1],
    ...
    },
    {
        ...
        color: "-",
        density: 1.696,
        discovered_by: "Andr�-Marie Amp�re",
        melt: 53.48,
        molar_heat: "-",
    ...
    },
    {
        ...
        summary: "Sodium /'so?di?m/ is a chemical element with symbol Na (from Ancient Greek ??t???) and atomic number 11. It is a soft, silver-white, highly reactive metal. In the Periodic table it is in column 1 (alkali metals), and shares with the other six elements in that column that it has a single electron in its outer shell, which it readily donates, creating a positively charged atom - a cation.",
        symbol: "Na",
        xpos: 1,
        ypos: 3,
        shells: [2, 8, 1],
    ...
    },
    {
        ...
        color: "-",
        density: 2.329,
        discovered_by: "J�ns Jacob Berzelius",
        melt: 1687,
        molar_heat: 19.789,
    ...
    },
    {
        ...
        color: "-",
        density: 6,
        discovered_by: "Andr�s Manuel del R�o",
        melt: 2183,
        molar_heat: 24.89,
    ...
    },
    {
        ...
        color: "-",
        density: 4.81,
        discovered_by: "J�ns Jakob Berzelius",
        melt: 494,
        molar_heat: 25.363,
        named_by: "-",
        number: 34,
    ...
    },
    {
        ...
        color: "-",
        density: 3.1028,
        discovered_by: "Antoine J�r�me Balard",
        melt: 265.8,
        molar_heat: "-",
        named_by: "-",
        number: 35,
        ...
        spectral_img: "-",
        summary: 'Bromine (from Ancient Greek:�??�??, br�mos, meaning "stench") is a chemical element with symbol Br, and atomic number 35. It is a halogen. The element was isolated independently by two chemists, Carl Jacob L�wig and Antoine Jerome Balard, in 1825�1826.',
        symbol: "Br",
        xpos: 17,
        ypos: 4,
        shells: [2, 8, 18, 7],
    ...
    },
    {
        ...
        summary: 'Krypton (from Greek:???pt?? kryptos "the hidden one") is a chemical element with symbol Kr and atomic number 36. It is a member of group 18 (noble gases) elements. A colorless, odorless, tasteless noble gas, krypton occurs in trace amounts in the atmosphere, is isolated by fractionally distilling liquefied air, and is often used with other rare gases in fluorescent lamps.',
        symbol: "Kr",
        xpos: 18,
        ypos: 4,
        shells: [2, 8, 18, 8],
    ...
    },
    {
        ...
        spectral_img: "-",
        summary: "Molybdenum is a chemical element with symbol Mo and atomic number 42. The name is from Neo-Latin molybdaenum, from Ancient Greek ????�d?? molybdos, meaning lead, since its ores were confused with lead ores. Molybdenum minerals have been known throughout history, but the element was discovered (in the sense of differentiating it as a new entity from the mineral salts of other metals) in 1778 by Carl Wilhelm Scheele.",
        symbol: "Mo",
        xpos: 6,
        ypos: 5,
        shells: [2, 8, 18, 13, 1],
    ...
    },
    {
        ...
        spectral_img: "-",
        summary: "Technetium (/t?k'ni??i?m/) is a chemical element with symbol Tc and atomic number 43. It is the element with the lowest atomic number in the periodic table that has no stable isotopes:every form of it is radioactive. Nearly all technetium is produced synthetically, and only minute amounts are found in nature.",
        symbol: "Tc",
        xpos: 7,
        ypos: 5,
        shells: [2, 8, 18, 13, 2],
    ...
    },
    {
        ...
        spectral_img: "-",
        summary: 'Silver is a chemical element with symbol Ag (Greek:??????? �rguros, Latin:argentum, both from the Indo-European root *h2er?- for "grey" or "shining") and atomic number 47. A soft, white, lustrous transition metal, it possesses the highest electrical conductivity, thermal conductivity and reflectivity of any metal. The metal occurs naturally in its pure, free form (native silver), as an alloy with gold and other metals, and in minerals such as argentite and chlorargyrite.',
        symbol: "Ag",
        xpos: 11,
        ypos: 5,
        shells: [2, 8, 18, 18, 1],
    ...
    {
        name: "Tin",
        appearance: "silvery-white (beta, �) or gray (alpha, a)",
    ...
    },
    {
        ...
        color: "-",
        density: 6.24,
        discovered_by: "Franz-Joseph M�ller von Reichenstein",
        melt: 722.66,
        molar_heat: 25.73,
        named_by: "-",
        number: 52,
    ...
    },
    {
        ...
        spectral_img: "-",
        summary: "Iodine is a chemical element with symbol I and atomic number 53. The name is from Greek ??e?d?? ioeides, meaning violet or purple, due to the color of iodine vapor. Iodine and its compounds are primarily used in nutrition, and industrially in the production of acetic acid and certain polymers.",
        symbol: "I",
        xpos: 17,
        ypos: 5,
        shells: [2, 8, 18, 18, 7],
    ...
    },
    {
        ...
        color: "-",
        density: 5.264,
        discovered_by: "Eug�ne-Anatole Demar�ay",
        melt: 1099,
        molar_heat: 27.66,
        named_by: "-",
        number: 63,
    ...
    },
    {
        ...
        spectral_img: "-",
        summary: 'Osmium (from Greek osme (?s�?) meaning "smell") is a chemical element with symbol Os and atomic number 76. It is a hard, brittle, bluish-white transition metal in the platinum group that is found as a trace element in alloys, mostly in platinum ores. Osmium is the densest naturally occurring element, with a density of 22.59 g/cm3.',
        symbol: "Os",
        xpos: 8,
        ypos: 6,
    ...
    },
    {
        ...
        spectral_img: "-",
        summary: "Lead (/l?d/) is a chemical element in the carbon group with symbol Pb (from Latin:plumbum) and atomic number 82. Lead is a soft, malleable and heavy post-transition metal. Metallic lead has a bluish-white color after being freshly cut, but it soon tarnishes to a dull grayish color when exposed to air.",
        symbol: "Pb",
        xpos: 14,
        ypos: 6,
    ...
    },
    {
        ...
        color: "-",
        density: 9.78,
        discovered_by: "Claude Fran�ois Geoffroy",
        melt: 544.7,
        molar_heat: 25.52,
        named_by: "-",
        number: 83,
    ...
    },
    {
        ...
        spectral_img: "-",
        summary: "Thorium is a chemical element with symbol Th and atomic number 90. A radioactive actinide metal, thorium is one of only two significantly radioactive elements that still occur naturally in large quantities as a primordial element (the other being uranium). It was discovered in 1828 by the Norwegian Reverend and amateur mineralogist Morten Thrane Esmark and identified by the Swedish chemist J�ns Jakob Berzelius, who named it after Thor, the Norse god of thunder.",
        symbol: "Th",
        xpos: 4,
        ypos: 10,
    ...
    },
    {
        ...
        color: "-",
        density: 37.1,
        discovered_by: "Gesellschaft f�r Schwerionenforschung",
        melt: "-",
        molar_heat: "-",
        named_by: "-",
        number: 107,
